...
if(isset($_POST[submit]))
{
	...
	else
	{
		$dt = date("Y-m-d");
		$tim = date("H:i:s");
		$sql ="INSERT INTO patient(patientname,admissiondate,admissiontime,address,city,mobileno,mail,loginid,password,gender,dob,status) values('$_POST[patiente]','$dt','$tim','$_POST[textarea]','$_POST[city]','$_POST[mobileno]','$_POST[mail]','$_POST[loginid]','$_POST[password]','$_POST[select6]','$_POST[dob]','Pending')";
   ...
   <form method="post" action="" name="frmpatapp" onSubmit="return validateform()">
    <table width="532" border="3">
      <tbody>
        ...
        <tr>		
		  <td>E-mail</td>
          <td><input type="mail" name="email" id="email" value="<?php echo $rspatient[mail];  ?>" <?php echo $readonly; ?> ></td>
