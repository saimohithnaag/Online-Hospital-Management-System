...
if(isset($_POST[submit]))
{
	...
	{
			$sql ="UPDATE patient SET patientname='$_POST[patientname]',admissiondate='$_POST[admissiondate]',admissiontime='$_POST[admissiontme]',address='$_POST[address]',mail='$_POST[mail]',mobileno='$_POST[mobilenumber]',city='$_POST[city]',pincode='$_POST[pincode]',loginid='$_POST[loginid]',password='$_POST[password]',bloodgroup='$_POST[select2]',gender='$_POST[select3]',dob='$_POST[dateofbirth]',status='$_POST[select]' WHERE patientid='$_GET[editid]'";
	...
	{
	$sql ="INSERT INTO patient(patientname,admissiondate,admissiontime,address,mail,mobileno,city,pincode,loginid,password,bloodgroup,gender,dob,status) values('$_POST[patientname]','$dt','$tim','$_POST[address]','$_POST[mail]','$_POST[mobilenumber]','$_POST[city]','$_POST[pincode]','$_POST[loginid]','$_POST[password]','$_POST[select2]','$_POST[select3]','$_POST[dateofbirth]','Active')";
	if($qsql = mysqli_query($con,$sql))
	{
...
?>
        ...
        <tr>
		<td>E-mail</td>
          <td><input type="mail" name="mail" id="mail" value="<?php echo $rsedit[mail]; ?>" /></td>
        </tr>
        <tr>
        <tr>
          <td>Mobile Number</td>
        ...
        <tr>
          <td colspan="2" align="center"><input style="background-color:#3d73b1" type="submit" name="submit" id="submit" value="Submit" /></td>
        </tr>
      </tbody>
    </table>
    </form>
...
function validateform()
{
	...
	else if(!document.frmpatient.mail.value.match(emailExp))
	{
		alert("Enter valid email id..");
		document.frmpatient.mail.focus();
		return false;
	}
