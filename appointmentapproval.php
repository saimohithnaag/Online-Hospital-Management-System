...
if(isset($_POST[submit]))
{
		if(isset($_GET[editid]))
		{
			...
			if($qsql = mysqli_query($con,$sql))
			{
				...
				echo "<script>window.location='sendmailapp.php?patientid=$_GET[patientid]&appointmentid=$_GET[editid]';</script>";
			}
			else
			{
...
<div class="wrapper col4">
  ...
  echo "<option value='$rsdepartment[departmentid]'>$rsdepartment[departmentname]</option>";
        ...
        <tr>
          <td colspan="2" align="center"><input type="submit" style="background-color:#3d73b1" name="submit" id="submit" value="Submit" /></a></td>
        </tr>
      </tbody>
    </table>
    </form>
