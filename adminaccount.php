...
<div class="wrapper col4">
  <div id="container">
  <p><form method="get" action=""><strong>Date -</strong> <input type="date" name="date" value="<?php echo $_GET[date]; ?>" ><input style="background-color:#3d73b1" type="submit" name="submit" value="Submit"></form></p>
