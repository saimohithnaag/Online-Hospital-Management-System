...
{  
	...
	sendmail("mohithnaag7@gmail.com","Mail from Appoint My Doctor",$message);
...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
OHMS Office, Rent-A-Desk Building, Jubilee Hills , Hyderabad<br />

<strong>Tel</strong>:+91 7702183363,+91 8297306092, +91 7893069357<br />
...
<strong>Email ID</strong>: ohms@gmail.com</p>
        ...
        <h6>Contact Us by entering following information</h6>
          ...
          <p>
            <input name="submit" style="background-color:#3d73b1" type="submit" id="submit" value="Submit Form"  />
            &nbsp;
            <input name="reset" style="background-color:#3d73b1" type="reset" id="reset" tabindex="5" value="Reset Form" />
          </p>
        </form>
