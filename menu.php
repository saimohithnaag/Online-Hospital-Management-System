...
background-image: -moz-linear-gradient(#fff, #0186ba); 
background-image: -webkit-gradient(linear, left top, left bottom, from(#fff), to(#0186ba));
background-image: -webkit-linear-gradient(#fff, #0186ba);
background-image: -o-linear-gradient(#fff, #0186ba);
background-image: -ms-linear-gradient(#fff, #0186ba);
background-image: linear-gradient(#fff, #0186ba);
}
